...
// static ArrayList responseTimeForachRunTime;   // response time = delay
    ...
    static int numberOfRuningTime = 11;  // JOp
...
//            }
    ...
    public void finalResultValues() {
        ...
        if (countNoOfRunningTime == numberOfRuningTime - 1) {
            ...
            l.add(methodName);
            l.add(Variables.numberOfNodesC1);
            ...
            if (Variables.servicePlacementCheck == false && Variables.taskPlacementCheck == true) {
                ...
                if (Variables.numberOfNodesC1 == 25) {
                    taskNumber = 10;
                } else if (Variables.numberOfNodesC1 == 50) {
                    taskNumber = 20;
                } else if (Variables.numberOfNodesC1 == 100) {
                    taskNumber = 30;
                } else if (Variables.numberOfNodesC1 == 200) {
                    taskNumber = 40;
                } else if (Variables.numberOfNodesC1 == 400) {
                    taskNumber = 50;
                }
