...
//            }
       ...
       // JOptionPane.showMessageDialog(null, totalTaskDelay + "\n" + maxTaskDelay + "\n" + minTaskDelay + "\n" + avgTaskDelay);
        ...
        if (countNoOfRunningTime == numberOfRuningTime - 1) {
            ...
            if (Variables.servicePlacementCheck == false && Variables.taskPlacementCheck == true) {
                ...
                if (Variables.c2_Over_c1 == 20) {
                    taskNumber = 10;
                } else if (Variables.c2_Over_c1 == 40) {
                    taskNumber = 20;
                } else if (Variables.c2_Over_c1 == 60) {
                    taskNumber = 30;
                } else if (Variables.c2_Over_c1 == 80) {
                    taskNumber = 40;
                } else if (Variables.c2_Over_c1 == 100) {
                    taskNumber = 50;
                }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter |Colony2| Over |Colony1| for Scenario #4  (20%, 40%, 60%, 80% or 100%) Fog Nodes");
        Variables.c2_Over_c1 = in1.nextInt();
        /*
