...
// ama arrayanay xwarawa bo kokrdnway anjamy hamw runing timeakana
    ...
    public void result() {
        ...
        mehtodNumber = Variables.policeNumber; //1; //in.nextInt();
...
//            }
    ...
    public void finalResultValues() {
        ...
        if (countNoOfRunningTime == numberOfRuningTime - 1) {
            ...
            l.add(methodName);
            l.add(Variables.percentOfFogNodesInBothColony);
            ...
            if (Variables.servicePlacementCheck == false && Variables.taskPlacementCheck == true) {
                ...
                if (Variables.percentOfFogNodesInBothColony == 20) {
                    taskNumber = 10;
                } else if (Variables.percentOfFogNodesInBothColony == 40) {
                    taskNumber = 20;
                } else if (Variables.percentOfFogNodesInBothColony == 60) {
                    taskNumber = 30;
                } else if (Variables.percentOfFogNodesInBothColony == 80) {
                    taskNumber = 40;
                } else if (Variables.percentOfFogNodesInBothColony == 100) {
                    taskNumber = 50;
                }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter Percent of Fog Nodes For Result Of Scenario #3  (20%, 40%, 60%, 80% or 100%) Fog Nodes");
        Variables.percentOfFogNodesInBothColony = in1.nextInt();
        /*
