...
public class Main {
    ...
    public void result() {
        ...
        mehtodNumber = Variables.policeNumber; // 3; //in.nextInt();
...
//            }
    ...
    public void finalResultValues() {
        ...
        //taskDelay = maxDelay;
       // JOptionPane.showMessageDialog(null,"Max: "+maxTaskDelay+"\nMin: "+minTaskDelay+"\nTot: "+totalTaskDelay+"\nAVG: "+avgTaskDelay);
       ...
       // JOptionPane.showMessageDialog(null, minResponseTime.size());
          
        // responseTimeForachRunTime.add(maxTaskDelay); // maxy har jarek wardagret w dwatr max yan avg hamw jarakan wardagren bo 4aksazy paperaka kadawakrabw 
        ...
        if (countNoOfRunningTime == numberOfRuningTime - 1) {
            ...
            // JOptionPane.showMessageDialog(null, resultForEachRunningTime.size());
            ...
            if (Variables.servicePlacementCheck == false && Variables.taskPlacementCheck == true) {
                ...
                if (Variables.NoOfService == 25) {
                    taskNumber = 10;
                } else if (Variables.NoOfService == 50) {
                    taskNumber = 20;
                } else if (Variables.NoOfService == 100) {
                    taskNumber = 30;
                } else if (Variables.NoOfService == 200) {
                    taskNumber = 40;
                } else if (Variables.NoOfService == 400) {
                    taskNumber = 50;
                }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1: Our Proposed Algorithm >>    2: Cloud Only >>    3: Edge Ward >>    4: Random Placement>>   5: Paper1 For Evaluation");
        Variables.policeNumber = in.nextInt();
        System.out.println("Enter number of IoT Devices / number of Tasks / number of Services [25, 50, 100, 200, 400]");
        Variables.NoOfServiceOtTaskorIoTDevice = in.nextInt();
...
//        for (int i = 0; i < Variables.servicesDeadline.size(); i++) {
//            
//            int delayIndexOfEachTask  = Variables.task_list.get(i).size()-2;
//            System.out.println("\t"+Variables.task_list.get(i).get(delayIndexOfEachTask)+"\t\t"+Variables.servicesDeadline.get(i));
//        }
    }
