    ...
    public Fog_Topology(int seeds, int methodNumber, int topology_type, int iot_devices) {
       ...
       // JOptionPane.showMessageDialog(null, seed);
        ...
        if (topology_type == 1) {
            ...
            Variables.graph_matrix_c = daynamicTopology(60, 140, "colony1", seeds, methodNumber);
            ...
            Variables.graph_matrix_c = daynamicTopology(30, 70, "colony2", seeds, methodNumber);
...
//        if (methodNumber == 20) // agar only cloud bw ba fog AP 0 bn w iot daxlbkret
//        {
//            fogNumber = 0;
//            accessPointNumber = 0;
//        } else {
        ...
        if (this.iot_devices == 1) {
            ...
            if (Variables.taskPlacementCheck == true) {
                if (Variables.iotAndTask == 0) {
                    ...
                    iotNumber = Variables.NoOfServiceOtTaskorIoTDevice; //400; //in.nextInt();;
